        ...
        <div className="bg-white h-4/5 overflow-y-scroll ">
            <div className="bg-stone-100 mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
              <h2 className="text-2xl font-bold tracking-tight text-gray-900">User</h2>
                <div className="grid grid-cols-2 gap-x-2 gap-y-2 sm:grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                  ...
                  <div className="shadow-2xl shadow-sky-700 sm:col-span-1 lg:col-span-2 xl:col-span-3 m-2 bg-sky-50 rounded-full hover:bg-sky-100 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-lg text-sm px-10 py-5 text-sky-900 dark:bg-sky-50 dark:hover:bg-sky-50 dark:focus:ring-sky-50 left-0">
                  ...
                  <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
                      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                          <thead class="text-xs text-gray-700 uppercase dark:text-gray-400">
                              <tr>
                                  ...
                                  <th scope="col" class="px-6 py-3 text-center dark:bg-gray-500">
                                      >>
                                  </th>
                                  <th scope="col" class="px-6 py-3 bg-gray-50 dark:bg-gray-800">
                                  INFORMATION ( ข้อมูล )
                          ...
                          <tbody>
                              ...
                              <tr class="border-b border-gray-200 dark:border-gray-700">
                                  ...
                                  <td class="px-6 py-4 text-center dark:bg-gray-500">
                                      >>
                                  </td>
                      ...
                      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 xl:gap-x-8">
